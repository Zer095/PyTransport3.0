...
plt.ylabel(r'$\tilde \varepsilon$', fontsize=labsz, rotation=0)
plt.xticks(fontsize=ticsz)
plt.xlim(left=1, right=14)
plt.yticks(fontsize=ticsz)
plt.legend(fontsize=legsz, framealpha=1.0)
plt.grid()
plt.savefig('plots/QA_GT_2pt.pdf', format='pdf',bbox_inches='tight')
...
plt.ylabel(r'$\tilde \varepsilon$', fontsize=labsz, rotation=0)
plt.xticks(fontsize=ticsz)
plt.xlim(left=1, right=13.5)
plt.yticks(fontsize=ticsz)
plt.legend(fontsize=legsz, framealpha=1.0, loc='lower left')
plt.grid()
plt.savefig('plots/QA_GT_3pt.pdf', format='pdf',bbox_inches='tight')
...
# plt.savefig('plots/QA_DeltaPz.pdf', format='pdf',bbox_inches='tight')
...
# plt.savefig('plots/QA_DeltafNL.pdf', format='pdf',bbox_inches='tight')
...
plt.legend(fontsize=legsz, framealpha=1.0)
plt.grid()
plt.savefig('plots/QA_Time_Pz.pdf', format='pdf',bbox_inches='tight')
...
plt.legend(fontsize=legsz, framealpha=1.0)
plt.grid()
plt.savefig('plots/QA_Time_fNL.pdf', format='pdf',bbox_inches='tight')
...
plt.savefig('plots/QA_DeltaPz_alt.pdf', format='pdf',bbox_inches='tight')
...
plt.savefig('plots/QA_DeltafNL_alt.pdf', format='pdf',bbox_inches='tight')
...
plt.vlines(x=goldtol2M[NB_index] + 0, ymin = 10**-14, ymax = 10**-0, linestyle='dashed', color=clr[0])
...
plt.legend(fontsize=legsz, framealpha=1.0)
plt.grid()
plt.savefig(f'plots/QA_DeltaPz_{NB}.pdf', format='pdf',bbox_inches='tight')
...
plt.legend(fontsize=legsz, framealpha=1.0)
plt.grid()
plt.savefig(f'plots/QA_2ptTime_{NB}.pdf', format='pdf',bbox_inches='tight') 
...
plt.hlines(y=threshold, xmin=-18, xmax=-5, linestyle=(0, (10, 5)), color='black')
plt.vlines(x=goldtol3M[NB_index] + 0.5, ymin = 10**-14, ymax = 10**-0, linestyle='dashed', color=clr[0])
...
plt.grid()
plt.savefig(f'plots/QA_DeltafNL_{NB}.pdf', format='pdf',bbox_inches='tight')
...
plt.legend(fontsize=legsz, framealpha=1.0)
plt.grid()
plt.savefig(f'plots/QA_3ptTime_{NB}.pdf', format='pdf',bbox_inches='tight')
#######################################################################################################################################
plt.show()