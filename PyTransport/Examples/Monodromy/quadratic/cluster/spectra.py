...
PyT_pz = (PyT_k**3/(2*np.pi**2))*PyT_twoPt[-1,1]
AN_pz = (AN_k**3/(2*np.pi**2))*AN_twoPt[-1,1]
FA_pz = (FA_k**3/(2*np.pi**2))*FA_twoPt[-1,1]
############################################################ Write file ############################################################
np.savetxt('zzz'+str(inter)+'.txt',(NOut[inter], PyT_k, PyT_pz, AN_k, AN_pz, FA_k, FA_pz ), newline='\n')
