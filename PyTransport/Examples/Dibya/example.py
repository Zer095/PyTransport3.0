...
import PyTransDibya as PyT                       # Import the model. Be sure the name is the same that appears in .compileName3 in xSetup.py
###############################################################################################################
##################################### Set initial values ######################################################
...
fields = np.array([30., 0.95])
params = np.zeros(nP)

params[0] = 6.38381076*pow(10., -19.)
params[1] = 8.3775804*pow(10., -7.); params[2] = 1.0; params[3] = pow(10.,-3.); params[4] = 5.*pow(10.,-4); params[5] = 501.9612;  params[6] = 50.*501.9612;  params[7] = pow(10.,-3);  params[8] = 5.0;  params[9] = 0.01;  params[10] = 1.17757* pow(10,-8.)
